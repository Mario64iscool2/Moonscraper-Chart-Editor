...
public class GroupMove : ToolObject
{
    ...
    List<Handshape> handshapeToEnable = new List<Handshape>();
    ...
    protected override void Update () {
        ...
        if (movingSongObjects.Count > 0)
        {
            ...
            else
            {
                ...
                editor.songObjectPoolManager.EnableHS(handshapeToEnable);
    ...
    public void StartMoveAction(IList<SongObject> songObjects, int anchorArrayPos, bool delete = false)
    {
        ...
        handshapeToEnable.AddRange(movingSongObjects.OfType<Handshape>());
