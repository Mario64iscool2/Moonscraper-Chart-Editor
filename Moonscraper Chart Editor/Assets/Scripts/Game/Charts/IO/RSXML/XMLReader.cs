...
namespace MoonscraperChartEditor.Song.IO
{
    public static class XMLReader
    {
        ...
        struct chordTemplate
        {
            ...
            public int finger0, finger1, finger2, finger3, finger4;
            public int fret0, fret1, fret2, fret3, fret4;
        }
       ...
       struct ebeat
        ...
        public static Song ReadChart(string filepath)
        {
            try
            {
                ...
                bool standardRocksmithFormat = extension == ".xml";

                if (standardRocksmithFormat)
                {
                    Song song = new Song();

                    ChartIOHelper.FileSubType fileLoadType = standardRocksmithFormat ? ChartIOHelper.FileSubType.Default : ChartIOHelper.FileSubType.MoonscraperPropriety;
        ...
        float time = Time.realtimeSinceStartup;
            ...
            System.Xml.XmlReader.Create(sr);
